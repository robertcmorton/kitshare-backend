      ...
      <table width="200" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          ...
          <tr>
            ...
            <td class="reff" style="font-size:12px; font-family:'Roboto', sans-serif; text-align:left;"></td>
          </tr>
        </tbody>
      </table></td>
  </tr>
...
<table width="700" border="0" style="margin:0 auto;" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="300" style="vertical-align: top;"><h2 style="width:300px;color:#095cab; font-family:'Roboto', sans-serif; border-bottom:2px solid #095cab; padding-bottom:10px;">BILLING TO</h2>
      <h3  style="margin:0; padding:0; font-family:'Roboto', sans-serif;"><?php echo  $addrsss->bussiness_name ?></h3>
      <p style="font-size:15px; color:#818181; margin:0; padding:5px 0px; font-family:'Roboto', sans-serif;"><?php echo  $addrsss->app_user_first_name.' '.$addrsss->app_user_last_name; ?></p>
      <p style="font-size:15px; color:#818181; margin:0; padding:5px 0px; font-family:'Roboto', sans-serif;"><?php  echo $addrsss->street_address_line1.$addrsss->street_address_line2;?></p>
      <p style="font-size:15px; color:#818181; margin:0; padding:5px 0px; font-family:'Roboto', sans-serif;"><?php echo $addrsss->suburb_name.$addrsss->ks_state_name;  ?></p>
      <p style="font-size:15px; color:#818181; margin:0; padding:5px 0px; font-family:'Roboto', sans-serif;"> <?php echo $addrsss->postcode; ?></p>
...
<table class="table table-condensed" width="530" style="margin:0px auto;" cellpadding="0" cellspacing="0">
  <thead>
    <tr>
      ...
      <td class="text-center" style="padding:5px 0px; border-bottom:1px solid #ddd"><strong> Replacement Value </strong></td>
      <td class="text-center" style="padding:5px 0px; border-bottom:1px solid #ddd"><strong>Rented Days</strong></td>
      <td class="text-right" style="padding:5px 0px; border-bottom:1px solid #ddd"><strong> Daily Rate</strong></td>
  ...
  <tbody>
    ...
    <?php
        ...
        $total_rent_amount  += $value->total_rent_amount_ex_gst -$value->beta_discount + $value->community_fee +$value->insurance_fee ; 
