		...
		$mail_content ='<!doctype html>
			...
			$mail_content .='
				...
				<table width="940" border="0" style="margin:0 auto;padding: 0px 10px;">
				  ...
				  <tr>
				    <td>
				     <a href="http://inferasolz.com/"> <button  style="background-color:#428bca; color:#fff; padding:10px 12px; border:none; margin-bottom:20px">ACCEPT</button> </a>
				     <a href="http://inferasolz.com/" ><button style="background-color:#ff0000; color:#fff; padding:10px 12px; border:none; margin-bottom:20px">DECLINE</button></a>
				    </td>
				  </tr>
				</table>
		...
		if ($app_user_id != '') {	
				...
				if (!empty($checklist)) {
					...
					foreach ($checklist as  $value) {
							$checklist[$i]->image = BASE_IMG.'site_upload/checklist/'.$value->image ; 
