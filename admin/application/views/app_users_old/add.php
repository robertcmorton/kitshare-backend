...
<div class="col-12">
  <div class="card">
    <div class="card-body">
      ...
      <form name="myUserFrm" id="myUserFrm" class="form-material m-t-40" action="<?php echo base_url();?>app_users/save" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="form-group col-md-6">
            <label>Username</label>
            <span style="color:#FF0000;">*</span>
            <input type="text" class="form-control form-control-line" id="app_username" placeholder="Username" name="app_username" value="<?php echo set_value('app_username'); ?>">
            <?php echo form_error('app_username','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>Primary Email Address</label>
            <span style="color:#FF0000;">*</span>
            <input type="email" class="form-control form-control-line" id="primary_email_address" placeholder="Primary Email Address" name="primary_email_address" value="<?php echo set_value('primary_email_address'); ?>">
        ...
        <input type="checkbox" id="showpass" onclick="myFunction()" class="filled-in chk-col-blue">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <span style="color:#FF0000;">*</span>
            <input type="text" class="form-control form-control-line" id="app_user_first_name" placeholder="First Name" name="app_user_first_name" value="<?php echo set_value('app_user_first_name'); ?>">
            <?php echo form_error('app_user_first_name','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>Last Name</label>
            <input type="text" class="form-control form-control-line" id="app_user_last_name" placeholder="Last Name" name="app_user_last_name" value="<?php echo set_value('app_user_last_name'); ?>">
        ...
        <div class="form material row">
          ...
          <div class="form-group col-md-6">
            ...
            <span style="color:#FF0000;">*</span>
            <input type="date" class="form-control form-control-line" id="user_birth_date" placeholder="Date of Birth" name="user_birth_date" value="<?php echo date('Y-m-d'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-line" id="user_unique_id_number" placeholder="User Unique ID Number" name="user_unique_id_number" value="<?php echo set_value('user_unique_id_number'); ?>">
            <?php echo form_error('user_unique_id_number','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>Australian Business Number</label>
            <input type="text" class="form-control form-control-line" id="australian_business_number" placeholder="Australian Business Number" name="australian_business_number" value="<?php echo set_value('australian_business_number'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <textarea rows=5 class="form-control form-control-line" id="user_description" placeholder="User Description" name="user_description" value="<?php echo set_value('user_description'); ?>"></textarea>
            <?php echo form_error('user_description','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>About Me</label>
            <textarea rows=5 class="form-control form-control-line" id="about_me" placeholder="About Me" name="about_me" value="<?php echo set_value('about_me'); ?>"></textarea>
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-line" id="primary_mobile_number" placeholder="Primary Mobile Number" name="primary_mobile_number" value="<?php echo set_value('primary_mobile_number'); ?>">
            <?php echo form_error('primary_mobile_number','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>Additional Mobile Number</label>
            <input type="text" class="form-control form-control-line" id="additional_mobile_number" placeholder="Additional Mobile Number" name="additional_mobile_number" value="<?php echo set_value('additional_mobile_number'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control form-control-line" id="additional_email_address_1" placeholder="Additional Email Address 1" name="additional_email_address_1" value="<?php echo set_value('additional_email_address_1'); ?>">
            <?php echo form_error('additional_email_address_1','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-4">
            <label>Additional Email Address 2</label>
            <input type="text" class="form-control form-control-line" id="additional_email_address_2" placeholder="Additional Email Address 2" name="additional_email_address_2" value="<?php echo set_value('additional_email_address_2'); ?>">
            <?php echo form_error('additional_email_address_2','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-4">
            <label>Additional Email Address 3</label>
            <input type="text" class="form-control form-control-line" id="additional_email_address_3" placeholder="Additional Email Address 3" name="additional_email_address_3" value="<?php echo set_value('additional_email_address_3'); ?>">
        ...
        <div class="form material row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control form-control-line" id="user_social_id" placeholder="User Social ID" name="user_social_id" value="<?php echo set_value('user_social_id'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type = "file" id="input-file-now" name = "user_profile_picture_link" size = "20"  accept='image/*' />
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-line" id="user_website" placeholder="User Website" name="user_website" value="<?php echo set_value('user_website'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-line" id="imdb_link" placeholder="IMDb Link" name="imdb_link" value="<?php echo set_value('imdb_link'); ?>">
            <?php echo form_error('imdb_link','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>Showreel Link</label>
            <input type="text" class="form-control form-control-line" id="showreel_link" placeholder="Showreel Link" name="showreel_link" value="<?php echo set_value('showreel_link'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-line" id="instagram_link" placeholder="Instagram Link" name="instagram_link" value="<?php echo set_value('instagram_link'); ?>">
            <?php echo form_error('instagram_link','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>Facebook Link</label>
            <input type="text" class="form-control form-control-line" id="facebook_link" placeholder="Facebook Link" name="facebook_link" value="<?php echo set_value('facebook_link'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-line" id="vimeo_link" placeholder="Vimeo Link" name="vimeo_link" value="<?php echo set_value('vimeo_link'); ?>">
            <?php echo form_error('vimeo_link','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>Youtube Link</label>
            <input type="text" class="form-control form-control-line" id="youtube_link" placeholder="Youtube Link" name="youtube_link" value="<?php echo set_value('youtube_link'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-line" id="flikr_link" placeholder="Flickr Link" name="flikr_link" value="<?php echo set_value('flikr_link'); ?>">
            <?php echo form_error('flikr_link','<span class="text-danger">','</span>'); ?> </div>
          <div class="form-group col-md-6">
            <label>Twitter Link</label>
            <input type="text" class="form-control form-control-line" id="twitter_link" placeholder="Twitter Link" name="twitter_link" value="<?php echo set_value('twitter_link'); ?>">
        ...
        <div class="form material row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-line" id="linkedin_link" placeholder="Linkedin Link" name="linkedin_link" value="<?php echo set_value('linkedin_link'); ?>">
        ...
        <div style="display:none;" id="block">
          <div class="form material row">
            <div class="form-group col-md-6">
              ...
              <textarea rows=5 class="form-control form-control-line" name="block_reason" id="block_reason" value="<?php echo set_value('block_reason'); ?>"></textarea>
