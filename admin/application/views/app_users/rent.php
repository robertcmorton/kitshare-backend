                 ...
                 <div class="table-responsive m-t-40">
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%" style="align:center;">
                      <thead>
                        ...
                        <th>#</th>
                       <!--  <th>Gear</th> -->
                       <th><a href="<?php echo base_url() ?>app_users/rent/<?php echo $id;?>/owner?order_by=<?php echo $order_by; ?>&limit=<?php echo $limit; ?>&per_page=<?php echo $offset; ?>">Gear Name<?php if($total_rows>1) { ?><i class="fa fa-angle-<?php echo $arrow; ?>" style="font-size: 24px;"></i><?php } ?></a></th>
                 ...
                 <div class="table-responsive m-t-40">
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%" style="align:center;">
                      <thead>
                        ...
                        <th>#</th>
                       <!--  <th>Gear</th> -->
                         <th><a href="<?php echo base_url() ?>app_users/rent/<?php echo $ownerlist['id'];?>/renter?order_by=<?php echo $order_by; ?>&limit=<?php echo $ownerlist['limit']; ?>&per_page=<?php echo $ownerlist['offset']; ?>">Gear Name<?php if($ownerlist['total_rows']>1) { ?><i class="fa fa-angle-<?php echo $arrow; ?>" style="font-size: 24px;"></i><?php } ?></a></th>
                        <th>Requested From</th>
                        <th>Requested To</th>
                        <th>Total Request Date</th>
                        <th>Paid</th>
