		<div class="form-group col-md-12">
			...
			<div class="form-group col-md-4">
				<label>Route </label>
				<input type="text" class="form-control form-control-line" id="street_address_line2" name="route[]" value="<?php echo set_value('route'); ?>">
			...
			<div class="form-group col-md-3">
		        ...
		        <br>
		         <input type="radio" name="default_address[]" value="<?php echo $counter;?>">
		        <?php echo form_error('postcode','<span class="text-danger">','</span>'); ?>
	       </div>
