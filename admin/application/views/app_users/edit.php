...
<div class="page-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
          ...
          <div class="card-body"> <small class="text-muted">Email address </small>
            ...
            foreach ($app_users_address as  $value) {
                        if ($value->default_address== '1') {
                          echo $value->street_address_line1.' '.$value->street_address_line2 .' '.$value->route .' '.$value->administrive_area_level_2 .' '.$value->administrive_area_level_2 .' '.$value->suburb_name .' '.$value->ks_state_name .' '.$value->ks_country_name .' ' .$value->postcode;
                       } 
           } ?></h6>
      ...
      <div class="form-group col-md-6">
        <label>Route</label>
        <input type="text" class="form-control form-control-line" id="route" name="route[]" value="<?php  if(!empty($app_users_address)){  echo $value->route; }  ?>">
