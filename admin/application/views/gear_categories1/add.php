                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								...
								<form class="form-material m-t-40" action="<?php echo base_url();?>gear_categories1/save" method="post" enctype="multipart/form-data"><input type="hidden" id="sub_cat" name="sub_cat" />
								    <div class="row">
										<input type="hidden" value="<?php echo $refer ;?>" name= "url_link" >
										<div class="col-sm-6">
									  ...
									  <div class="row">
										<div class="col-sm-6">
										  <div class="form-group">
											...
											<input type="text" class="form-control" name="gear_category_name" id="gear_category_name" value="<?php echo set_value('gear_category_name'); ?>" placeholder="Category Name">
									   ...
									   <div class="row">
										...
										<select class="form-control select2" name="security_deposit" id="security_deposit" style="width:100%;"  >
											...
											<label for="security_deposit" class="error" style="color:#FF0000; display:none;"></label>
											<?php echo form_error('security_deposit','<span class="text-danger">','</span>'); ?> </div>
										</div>
									  </div>
									   <div class="row">
										<div class="col-sm-6">
										  <div class="form-group">
											...
											<input type="text" class="form-control" name="average_value" id="average_value" value="<?php echo set_value('average_value'); ?>" placeholder="Average Value">
											<label for="average_value" class="error" style="color:#FF0000; display:none;"></label>
											<?php echo form_error('average_value','<span class="text-danger">','</span>'); ?> </div>
										</div>
									  </div>
									  <div class="row">
										<div class="col-sm-6">
