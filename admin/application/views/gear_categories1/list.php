        ...
        <div class="box-header with-border">
          ...
          <div class="panel-body">
            <div class="has-feedback">
              <form class="form-inline  example" data-toggle="validator" role="form" method="get" action="<?php echo base_url();?>gear_categories1">
                <div class="col-md-6 no_padding">
                  <input type="text" class="" name="gear_category_name" placeholder="Category Name" value="<?php echo $gear_category_name; ?>">
                  <button type="submit"><i class="fa fa-search"></i></button>
                </div>
                <div class="form-group col-md-3"> <a href="<?php echo base_url();?>gear_categories1/add" class="btn btn-primary pull-right add_userbtn">Add Gear Category <i class="fa fa-plus" aria-hidden="true"></i></a> </div>
              </form>
            </div>
			<div class="pull-right">
				...
				<a href="<?php echo base_url();?>gear_categories1/downloadallcsv" class="btn btn-primary add_userbtn">CSV Download&nbsp;<i class="fa fa-download" aria-hidden="true"></i> </a>
			</div>
          </div>
          <!-- /.box-tools -->
        </div>
        <!-- /.box-header -->
        <form name="bulk_action_form" action="<?php echo base_url();?>gear_categories1/select_delete" method="post" onSubmit="return delete_confirm();"/>
            ...
            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%" style="align:center;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="mailbox-date"><a href="<?php echo base_url();?>gear_categories1/index/<?php echo $row->gear_category_id; ?>"><?php echo $row->gear_category_name;?></a></td>
                  ...
                  <td class="mailbox-date"><a href="<?php echo base_url();?>gear_categories1/edit/<?php echo $row->gear_category_id; ?>" title="Modify" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> <a onClick="return confirm('Would You Like To Delete This ?');" href="<?php echo base_url();?>gear_categories1/delete_record/<?php echo $row->gear_category_id; ?>" title="Delete" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a> </td>
                </tr>
                <?php $i++; }   ?>
                <?php } else {?>
                <tr>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <form class="form-inline" data-toggle="validator" role="form" method="post" action="<?php echo base_url();?>gear_categories1/import1" enctype="multipart/form-data">
...
<div id="myModalModify" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <form class="form-inline" data-toggle="validator" role="form" method="post" action="<?php echo base_url();?>gear_categories1/import_to_modify" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            <input type="file" name="file" id="csv">
            </br>
