<?php	
	if($cnt>0){
  ?>
    <div id="category_<?php echo $y+1; ?>"><br><select name="gear_category_id_<?php echo $y+1; ?>" id="gear_category_id" class="form-control" onChange="findnext(this.value,<?php echo $y+1; ?>,<?php echo $cnt2;?>)">
