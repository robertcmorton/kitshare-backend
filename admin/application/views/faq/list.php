...
<div class="row page-titles">
  <div class="col-md-5 col-8 align-self-center">
    <h3 class="text-themecolor m-b-0 m-t-0">FAQ Category List</h3>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>home">Dashboard</a></li>
      <li class="breadcrumb-item active">FAQ Category List</li>
    </ol>
  </div>
</div>
<!-- ============================================================== -->
    ...
    <div class="card">
      <div class="card-body">
        ...
        <h6 class="card-subtitle">(
          <?php if($total_rows>1){ echo $total_rows." Category"; }else{ echo $total_rows." Gears"; }?>
          )</h6>
            ...
            <div class="has-feedback">
              <form class="form-inline example example53" data-toggle="validator" role="form" method="get" action="<?php echo base_url();?>gear_desc">
               <!--  <div class="form-group col-md-10 no_padding">
                ...
                <div class="form-group col-md-2 pull-right"> <a href="<?php echo base_url();?>Faq/add" class="btn btn-primary pull-right add_userbtn">Add FAQ Category &nbsp;<i class="fa fa-plus" aria-hidden="true"></i></a> </div>
              </form>
              <!-- </div> -->
              <!-- </div> -->
            </div>
        ...
        <!-- /.box-header -->
        <form name="bulk_action_form" action="<?php echo base_url();?>faq/select_delete" method="post" onSubmit="return delete_confirm();"/>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="mailbox-date">
            				  ...
            				  <a href="<?php echo base_url();?>Faq/edit/<?php echo $row->id; ?>" title="Modify"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                      <a onClick="return confirm('Would You Like To Delete This?');" href="<?php echo base_url();?>Faq/delete_record/<?php echo $row->id; ?>" title="Delete"><i class="fa fa-trash-o"></i></a>
                  </td>
                </tr>
                <?php $i++; }   ?>
                <?php } else {?>
