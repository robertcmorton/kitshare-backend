...
<div class="col-12">
  <div class="card">
    <div class="card-body">
      ...
      <form class="form-material m-t-40" name="frm" action="<?php echo base_url();?>Faq/update" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="category_name" id="category_name" value="<?php echo $result->category_name; ?>"   required placeholder="Category Name ">
          ...
          <input type="hidden" class="form-control" name="permalink" id="permalink" value="<?php echo $result->permalink; ?>" required  placeholder="Title">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <select type="file" class="form-control" name="status" id="status"  placeholder="Status">
                <option value="Y" <?php if($result->status == 'Y'){echo 'selected' ;}?> >Active</option>
                <option value="N" <?php if($result->status == 'N'){echo 'selected' ;}?> >Inactive</option>
               </select>  
              <label for="" class="error" style="color:#FF0000; display:none;"></label>
