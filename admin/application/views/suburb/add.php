...
<div class="col-12">
  <div class="card">
    <div class="card-body">
      ...
      <form class="form-material m-t-40" id="myFrm" action="<?php echo base_url();?>suburb/save" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              <label for="ks_country_id">State</label>
              <span style="color:#FF0000;">*</span>
              <select class="form-control valid" name="ks_state_id" id="ks_state_id" onchange="otherCountry()">
                <option value="">--Select State--</option>
                <?php foreach($states as $key=>$val){ ?>
                <option value="<?php echo $val->ks_state_id; ?>"><?php echo $val->ks_state_name; ?></option>
                <?php } ?>
              </select>
        ...
        <div class="row" >
		  ...
		  <div class="col-sm-6">
            <div class="form-group">
              ...
              <input placeholder="Timezone" name="time_zone" id="time_zone" class="form-control" value="" type="text">
              <label for="time_zone" class="error" style="color:red; display:none; font-size:12px"></label>
            </div>
          </div>
        </div>
        <div class="clr"></div>
