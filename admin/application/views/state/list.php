    ...
    <div class="card">
      <div class="card-body">
        ...
        <h6 class="card-subtitle">(
          <?php if($total_rows>1){ echo $total_rows." States"; }else{ echo $total_rows." State"; } ?>
          )</h6>
            ...
            <div class="has-feedback">
              <form class="form-inline example example52" data-toggle="validator" role="form" method="get" action="<?php echo base_url();?>state">
                <div class="col-md-8 no_padding">
                  ...
                  <input type="text" class="" name="ks_country_name" placeholder="Country" value="<?php echo $ks_country_name; ?>">
            ...
            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%" style="align:center;">
              <thead>
                <tr>
                  ...
                  <th>State</th>
                  <th>State Code</th>
                  <th>Emergency Services Levy (ESL)</th>
                  <th>Stamp Duty (S/D)</th>
				          <th>Base Rate </th>
                  <th>Created Date</th>
                  <th>Status</th>
              ...
              <tbody>
                ...
                <tr>
                  <td><input type="checkbox" name="checked_id[]" class="checkbox" id="checked_id" value="<?php echo $row->ks_state_id;?>"></td>
                  ...
                  <td class="mailbox-subject"><?php echo $row->ks_state_code;?></td>
                  <td class="mailbox-subject"><?php echo $row->ks_state_esl;?></td>
                  <td class="mailbox-subject"><?php echo $row->ks_state_sd;?></td>
				          <td class="mailbox-subject"><?php echo $row->base_rate;?></td>
                  ...
                  <td class="mailbox-date"><a href="<?php echo base_url();?>state/edit/<?php echo $row->ks_state_id; ?>" title="Edit" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a><a onClick="return confirm('Would You Like To Delete This?');" href="<?php echo base_url();?>state/delete_record/<?php echo $row->ks_state_id; ?>" title="Delete" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a></td>
                </tr>
                <?php $i++; } ?>
                <?php } else { ?>
                <tr>
