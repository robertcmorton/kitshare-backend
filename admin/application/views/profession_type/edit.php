            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Modify Profession Type</h3>
                        <ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>home">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>profession_type">Profession Type List</a></li>
                            <li class="breadcrumb-item active">Modify Profession Type</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" action="<?php echo base_url();?>profession_type/update" method="post" enctype="multipart/form-data">
								    <div class="row">
									<div class="col-sm-6">
									  <div class="form-group mbr">
										<label for="exampleInputEmail1">Profession Type:</label>
										<input type="hidden" value="<?php echo $result[0]->profession_type_id; ?>" name="profession_type_id" id="profession_type_id" />
										<input type="text" name="profession_name" id="profession_name" placeholder="Profession Type" class="form-control" value="<?php echo $result[0]->profession_name; ?>" />
								  ...
								  <div class="col-sm-6">
									  <div class="form-group mbr">
										...
										<textarea name="profession_desc" id="profession_desc" placeholder="Description"  rows="10" cols="80" class="form-control" required><?php echo $result[0]->profession_desc; ?></textarea>
										<label for="owner_type_name" class="error" style="color:#FF0000; display:none;"></label>
