								    ...
								    <div class="row">
											<div class="col-sm-6">
											  <div class="form-group">
												...
												<div id="country_tt">
												<input type="hidden" name="gs_state_id" value="<?php echo $result[0]->gs_state_id; ?>"  />
												<select class="form-control valid" id="gs_country_id" name="gs_country_id" onchange="otherCountry()">
													<option value="">--Select Country--</option>
													<?php foreach($countries as $key=>$val){ ?>
													<option value="<?php echo $val->gs_country_id; ?>" <?php if($val->gs_country_id==$result[0]->gs_country_id) echo "selected='selected'" ; ?>><?php echo $val->gs_country_name; ?></option>
												  <?php } ?>
												  <option value="other">Other</option>
													</select></div>
												<label for="country_id" class="error" style="color:red; display:none;"></label>
										  ...
										  <div class="row">
											<div class="col-sm-6">
											  <div class="form-group">
												...
												<span style="color:#FF0000;">*</span>
												<input type="text" placeholder="State" name="gs_state_name" id="gs_state_name"  class="form-control" value="<?php echo $result[0]->gs_state_name; ?>" required>
												<label for="gs_state_name" class="error" style="color:red; display:none;"></label>
												<?php echo form_error('gs_state_name','<span class="text-danger">','</span>'); ?>
											  </div>
											</div>
