              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
					...
					<td class="mailbox-subject"><?php echo $row->username;?></td>
					<td>
					<?php
					if($row->level >0){
					$record=$this->db->query('select username from tbl_app_user where app_user_id='.$row->level.'');
			        echo $name=$record->row()->username;	
