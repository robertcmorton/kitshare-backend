								    ...
								    <div class="row">
										<div class="col-sm-6">
										  <div class="form-group mbr">
											...
											<input type="hidden" value="<?php echo $result[0]->ks_country_id; ?>" name="ks_country_id" id="ks_country_id" />
											<input type="text" name="ks_country_name" id="ks_country_name" placeholder="Country" class="form-control" value="<?php echo $result[0]->ks_country_name; ?>" />
