            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Modify Owner Type</h3>
                        <ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>home">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>owner_type">Owner Type List</a></li>
                            <li class="breadcrumb-item active">Modify Owner Type</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" action="<?php echo base_url();?>owner_type/update" method="post" enctype="multipart/form-data">
								    <div class="row">
									<div class="col-sm-4">
									  <div class="form-group mbr">
										<label for="exampleInputEmail1">Owner Type:</label>
										<input type="hidden" value="<?php echo $result[0]->owner_type_id; ?>" name="owner_type_id" id="owner_type_id" />
										<input type="text" name="owner_type_name" id="owner_type_name" placeholder="Owner Type" class="form-control" value="<?php echo $result[0]->owner_type_name; ?>" />
