...
<div class="row page-titles">
  <div class="col-md-5 col-8 align-self-center">
    <h3 class="text-themecolor m-b-0 m-t-0">Page</h3>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>home">Dashboard</a></li>
      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>pages">Page List</a></li>
...
<div class="col-12">
  <div class="card">
    <div class="card-body">
      ...
      <form class="form-material m-t-40" action="<?php echo base_url();?>pages/save_page" method="post" id="myFrm" enctype="multipart/form-data">
        <div class="form-group col-md-10">
          <label for="exampleInputarticle">Page Name</label>
          <input type="text"  class="form-control"  name="page" id="page" value="<?php echo set_value('page'); ?>" placeholder="Page Name">
          <?php echo form_error('page','<span class="text-danger">','</span>'); ?> </div>
        <div class="form-group col-md-10">
          <label for="exampleInputarticle">Page Code</label>
          <input type="text"  class="form-control"  name="page_code" id="page_code" value="<?php echo set_value('page_code'); ?>" placeholder="Page Code">
          <?php echo form_error('page_code','<span class="text-danger">','</span>'); ?> </div>
        <div class="form-group col-md-10">
          <label for="exampleInputarticle">Page Content</label>
          <textarea type="text" class="form-control" id="content" name="content" rows="10" cols="80" placeholder="Enter Page Content Here">
				</textarea>
