                            ...
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" name="frm" action="<?php echo base_url();?>user_bank_details/save" method="post" enctype="multipart/form-data"><input type="hidden" id="sub_cat" name="sub_cat" />
									...
									<div class="form-group col-md-3">
										...
										<input type="text" class="form-control" name="branch_zip_code" id="branch_zip_code" value="<?php echo set_value('branch_zip_code'); ?>" placeholder="Branch Zip Code">
									...
									<div class="form-group col-md-4">
										...
										<select class="form-control" name="branch_suburb_id" id="branch_suburb_id" value="<?php echo set_value('branch_suburb_id'); ?>">
