                            ...
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" name="frm" action="<?php echo base_url();?>user_bank_details/update" method="post" enctype="multipart/form-data"><input type="hidden" id="user_bank_detail_id" name="user_bank_detail_id" value="<?php echo $result[0]->user_bank_detail_id; ?>"/>
									...
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control" name="user_account_name" id="user_account_name" value="<?php echo $result[0]->user_account_name; ?>" placeholder="Account Name">
										<label for="user_account_name" class="error" style="color:#FF0000; display:none;"></label>
										<?php echo form_error('user_account_name','<span class="text-danger">','</span>'); ?> 
									</div>
									</div>
									<div class="row">
									...
									<div class="form-group col-md-4">
										...
										<select class="form-control" name="branch_suburb_id" id="branch_suburb_id"  onchange="findpincode(this.value)">
