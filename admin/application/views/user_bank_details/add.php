            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Add User Bank Detail</h3>
                        <ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>home">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>user_bank_details">User Bank Details List</a></li>
                            <li class="breadcrumb-item active">Add User Bank Detail</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" name="frm" action="<?php echo base_url();?>user_bank_details/save" method="post" enctype="multipart/form-data"><input type="hidden" id="sub_cat" name="sub_cat" />
									<div class="row">
									<div class="form-group col-md-4">
										...
										<select class="form-control" name="bank_id" id="bank_id" value="<?php echo set_value('bank_id'); ?>">
											...
											<option value="<?php echo $u->bank_id;?>"><?php echo $u->bank_name; ?></option>
											<?php } ?>
										</select>
									...
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control" name="account_type" id="account_type" value="<?php echo set_value('account_type'); ?>" placeholder="Account Type">
									...
									<!-- <div class="form-group col-md-6">
										...
										<input type="text" class="form-control" name="branch_code" id="branch_code" value="<?php echo set_value('branch_code'); ?>" placeholder="Branch Code">
									...
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control" name="bsb_number" id="bsb_number" value="<?php echo set_value('bsb_number'); ?>" placeholder="BSB Number">
									...
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control" name="branch_address" id="branch_address" value="<?php echo set_value('branch_address'); ?>" placeholder="Branch Address">
										...
										<select class="form-control" name="branch_country_id" id="branch_country_id" value="<?php echo set_value('branch_country_id'); ?>" onChange="findstate(this.value)">
											<option value="">--Select Country--</option>
											<?php foreach($country as $c){?>
											<option value="<?php echo $c->ks_country_id;?>"><?php echo $c->ks_country_name; ?></option>
											<?php } ?>
										</select>
									...
									<!-- <div class="form-group col-md-3">
										...
										<input type="text" class="form-control" name="branch_street" id="branch_street" value="<?php echo set_value('branch_street'); ?>" placeholder="Branch Street">
									...
									<div class="form-group col-md-3">
										...
										<input type="text" class="form-control" name="branch_city" id="branch_city" value="<?php echo set_value('branch_city'); ?>" placeholder="Branch City">
									...
									<div class="form-group col-md-4">
										...
										<select class="form-control" name="branch_suburb_id" id="branch_suburb_id" value="<?php echo set_value('branch_suburb_id'); ?>" onChange="findpincode(this.value)">
									...
									<div class="form-group col-md-4">
										<label for="exampleInputarticle">Branch Postcode</label>
										<input type="text" class="form-control" name="branch_zip_code" id="branch_zip_code" value="<?php echo set_value('branch_zip_code'); ?>" placeholder="Branch Postcode">
									...
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control" name="user_account_number" id="user_account_number" value="<?php echo set_value('user_account_number'); ?>" placeholder="User Account Number">
									...
									<div class="form-group col-md-4">
										<label for="exampleInputImage">Braintree Connection</label>
											<select class="form-control select2" name="accept_stripe_connection" id="accept_stripe_connection" style="width:100%;" value="<?php echo set_value('accept_stripe_connection'); ?>">
...
function findpincode(x){
	j.ajax({
            type:"post",
            url:"<?php echo base_url(); ?>user_bank_details/ajax_pincode",
            data:{data:x},
            success:function(response){
				j("#branch_zip_code").val(response);
            }
        });
}
  </script>