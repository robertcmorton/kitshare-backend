    ...
    <div class="login-box card">
      <div class="card-body">
	   <?php echo  $this->session->flashdata('success'); ?>
        <form class="form-horizontal form-material" id="loginform" action="<?php echo base_url();?>login/admin_login" method="post">
          ...
          <div class="form-group">
            <div class="col-md-12"> <a href="javascript:void(0)" id="to-recover" class="text-dark"><i class="fa fa-lock m-r-5"></i> Forgot password?</a> </div>
          </div>
          <div class="form-group text-center m-t-20">
            <div class="col-xs-12">
              <button class="btn btn-info btn-lg btn-block text-uppercase">Log In</button>
            </div>
          </div>
          <div class="row">
        ...
        <form class="form-horizontal" id="recoverform" action="<?php echo base_url() ?>forgot_password/send" method="post">
          <div class="form-group ">
            <div class="col-xs-12">
