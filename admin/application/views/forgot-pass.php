  ...
  <div class="login-register" style="background-image: url(<?php echo base_url();?>assets/images/black-and-white-2876387_1920.jpg);">
    ...
    <div class="login-box card">
	  ...
	  <?php echo  $this->session->flashdata('success'); ?>
        <form class="form-horizontal form-material" id="loginform" action="<?php echo base_url() ?>forgot_password/send" method="post">
          ...
          <div class="form-group text-center m-t-20">
            <div class="col-xs-12">
              <button class="btn btn-info btn-lg btn-block text-uppercase">Submit</button>
            </div>
          </div>
