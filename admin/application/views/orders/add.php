  ...
  <div class="card">
    <div class="card-body">
      ...
      <form class="form-material m-t-40" id="myFrm" action="<?php echo base_url();?>app_users/save" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control form-control-line" id="user_unique_id_number" name="user_unique_id_number" value="<?php echo  $unique_id ;?>" readonly>
      ...
      <div class="form-group col-md-3">
        ...
        <br>
        <input type="radio" class="default_address_1" id="default_address" name="default_address_1" onclick= "defaultaddress(1)" value="0">
        <?php echo form_error('postcode','<span class="text-danger">','</span>'); ?>
      </div>
