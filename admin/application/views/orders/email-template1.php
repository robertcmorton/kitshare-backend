...
<table width="550" border="0" style="margin:0 auto;" cellspacing="0" cellpadding="0">
  <tr>
    <td  width="300"><img width="60%" height="60%" src="<?php echo base_url(); ?>/assets/images/pdf_logo.png" ></td>
      ...
      <table width="200" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          ...
          <tr>
            ...
            <td class="reff" style="font-size:11px; font-family:'Roboto', sans-serif; text-align:left;"><?php echo date('d-M-Y',strtotime($order_details[0]->gear_rent_requested_on)); ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="reff" style="font-size:12px; font-family:'Roboto', sans-serif; text-align:left;"><?php echo $addrsss1->owner_app_user_first_name . $addrsss1->owner_app_user_last_name;  ?></td>
          </tr>
        </tbody>
      </table></td>
  </tr>
...
<table width="700" border="0" style="margin:0 auto;" cellspacing="0" cellpadding="0">
  <tr>
    <td width="300" style="vertical-align: top;">
      ...
      <p style="font-size:15px; color:#818181; margin:0; padding:5px 0px; font-family:'Roboto', sans-serif;">ABN 85 623 435 709 </p>
    </td>  
     <td width="300" style="vertical-align: top;"><h2 style="width:300px;color:#095cab; font-family:'Roboto', sans-serif; border-bottom:2px solid #095cab; padding-bottom:10px;">BILLING TO</h2>
      <?php  if (!empty($addrsss)) {
		  if(!empty($addrsss->renter_app_user_first_name)){
        ?>
	  
      <h3  style="margin:0; padding:0; font-family:'Roboto', sans-serif;"><?php echo  $addrsss->renter_app_user_first_name ?></h3>
	  <?php 
		  }
	  ?>
