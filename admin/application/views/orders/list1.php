 ...
 -->
          ...
          //print_r($row); die;?>
                ...
                <tr>
                  ...
                  <td class="mailbox-subject"><?php echo  $row->total_rent_amount;?></td>

                  <td class="mailbox-subject"><?php if($row->is_rent_approved == 'Y'){ echo "Reservation " ; }else{ echo " Quote "; } ?></td>
                  <td class="mailbox-subject"><?php if($row->is_rent_cancelled   == 'Y'){ echo "Cancelled  " ; }else{ echo "Not Cancelled  "; } ?></td>
                  <td class="mailbox-subject"><?php if($row->is_rent_rejected   == 'Y'){ echo "Rejected   " ; }else{ echo "Not Rejected   "; } ?></td>
